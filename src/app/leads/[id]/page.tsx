  ...
  return (
    <Shell title={`${lead.firstName} ${lead.lastName}`}>
      <div className="mb-4 flex items-center gap-2 text-xs text-brand-muted">
        <Link href="/leads" className="inline-flex items-center gap-1 rounded-md border border-transparent px-1.5 py-0.5 transition hover:border-brand-hairline hover:bg-white hover:text-brand-navy">
          <span aria-hidden>←</span> All leads
        </Link>
        <span aria-hidden className="text-brand-hairline">/</span>
        <span className="text-brand-navy/70">{lead.firstName} {lead.lastName}</span>
      </div>

      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          <Card className="overflow-hidden">
            {/* Thin gradient accent strip — gives the hero card a subtle signature without
            ...
            <CardBody>
              <div className="flex items-start justify-between gap-6">
                <div className="flex min-w-0 items-start gap-4">
                  <div
                    aria-hidden
                    className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-brand-blue to-brand-blue-dark text-base font-semibold text-white shadow-[inset_0_1px_0_0_rgb(255_255_255/0.2),0_4px_10px_-2px_rgb(0_91_247/0.4)]"
                  >
                  ...
                  <div className="min-w-0">
                    ...
                    {lead.painPoint ? (
                      <p className="mt-3 max-w-2xl rounded-lg border border-brand-blue-soft/40 bg-brand-blue-tint/60 px-3 py-2 text-sm text-brand-navy">
                        {lead.painPoint}
                      </p>
                    ) : null}
                  </div>
